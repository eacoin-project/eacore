...
This mechanism has been integrated into Bitcore-Node-EACoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/eacoinpay/insight-api-eacoin#web-socket-api](https://github.com/eacoinpay/insight-api-eacoin#web-socket-api) 
* API: [https://github.com/eacoinpay/insight-api-eacoin#instantsend-transactions](https://github.com/eacoinpay/insight-api-eacoin#instantsend-transactions) 
...
By default, the EACoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the EACoin Core daemon:
