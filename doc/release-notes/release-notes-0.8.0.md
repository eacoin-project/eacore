EACoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/eacoin/files/EACoin/eacoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the EACoin
...
New/changed settings (command-line or eacoin.conf file)
--------------------------------------------------------
