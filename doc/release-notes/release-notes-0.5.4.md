EACoin version 0.5.4 is now available for download at:
http://sourceforge.net/projects/eacoin/files/EACoin/eacoin-0.5.4/
...
http://gitorious.org/eacoin/eacoind-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix EACoin-Qt notifications under Growl 1.3.
Increase required age of EACoin-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxEACoin properly when installing EACoin-Qt over it. (Windows)
