...
EACoin Core version 0.12.0 is now available from:

  https://eacoinpay.io/downloads

Please report bugs using the issue tracker at github:

  https://github.com/eacoinpay/eacoin/issues
...
backwards-compatible with pre-0.12 versions of EACoin Core or other software:
