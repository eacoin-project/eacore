EACoin Core version 0.9.4 is now available from:

  https://eacoin.org/bin/0.9.4/
...
this update is incompatible with the EACoin system and could lead to consensus
forks.

EACoin Core released binaries from https://eacoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~eacoin/+archive/ubuntu/eacoin
- A third-party or self-compiled EACoin Core

upgrade to EACoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
