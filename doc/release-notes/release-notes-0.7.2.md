EACoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/eacoin/files/EACoin/eacoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused EACoin-Qt to crash on Windows when exiting.
