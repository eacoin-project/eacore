...
This document provides guidelines for internationalization of the EACoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `eacoin_en.ts` remains unchanged.
