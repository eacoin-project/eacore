...
#ifndef EACOIN_TEST_SCRIPTNUM10_H
#define EACOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from EACoin Core 0.10.0, for cross-comparison.
 */
public:
