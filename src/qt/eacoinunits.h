...
#ifndef EACOIN_QT_EACOINUNITS_H
#define EACOIN_QT_EACOINUNITS_H
...
/** EACoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class EACoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit EACoinUnits(QObject *parent);

    /** EACoin units.
      @note Source: https://en.eacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        EAC,
...
typedef EACoinUnits::Unit EACoinUnit;

#endif // EACOIN_QT_EACOINUNITS_H
