...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About EACoin Core"), this);
    ...
    showHelpMessageAction->setStatusTip(tr("Show the EACoin Core help message to get a list with possible EACoin Core command-line options"));
...
{
    QString strTitle = tr("EACoin Core"); // default title
