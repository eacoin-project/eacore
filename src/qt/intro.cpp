...
void Intro::pickDataDirectory()
{
    ...
    if(!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", DEFAULT_CHOOSE_DATADIR))
    {
        ...
        intro.setWindowIcon(QIcon(":icons/eacoin"));
        ...
        while(true)
        {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("EACoin Core"),
     ...
     * override -datadir in the eacoin.conf file in the default data directory
     * (to be consistent with eacoind behavior)
     */
    if(dataDir != getDefaultDataDirectory())
