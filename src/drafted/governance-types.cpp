...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "EACoinNetwork") type = EACoinNetwork;
    if(strType == "EACoinNetworkVariable") type = EACoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == EACoinNetwork) s = "EACoinNetwork";
    if(type == EACoinNetworkVariable) s = "EACoinNetworkVariable";
