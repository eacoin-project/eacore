 ...
 *
 *   // network
 *   CEACoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.eacoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CEACoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: EACoinNetwork
// //   -- signature requirements : Key1(User)
// class CEACoinNetworkVariable : public CGovernanceObject
// {
// private:
