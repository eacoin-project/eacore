...
{
    if(fLiteMode) return; // ignore all EACoin related functionality
...
/*
    ...
    allow endless transaction that would bloat EACoin and make it unusable. To
...
void ThreadCheckDarkSendPool()
{
    ...
    RenameThread("eacoin-privatesend");
