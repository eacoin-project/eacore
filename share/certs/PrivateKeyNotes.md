...
unlocked to sign the EACoin-Qt.app bundle.
...
allowing somebody to distribute a EACoin-Qt.app or eacoin-qt-setup.exe with a valid
...
that the eacoin-qt.exe file inside the installer had not been tampered with.
